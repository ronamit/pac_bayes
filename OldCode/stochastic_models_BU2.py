...
class ConvNet3(base_stochastic_model):
    def __init__(self, prm, input_shape, n_classes):
        ...
        self.conv_layers = nn.Sequential(OrderedDict([
                ('conv1', StochasticConv2d(n_in_channels, n_filt1, kernel_size=5, prm=prm)),
                ('pool1', nn.MaxPool2d(kernel_size=2, stride=None)),
                ('a1',  nn.ELU()),
                ('conv2', StochasticConv2d(n_filt1, n_filt2, kernel_size=5, prm=prm)),
        ...
        self.add_module('fc1', StochasticLinear(conv_out_size, n_hidden_fc1, prm))
        self.add_module('a3', nn.ELU()),
        self.add_module('fc_out', StochasticLinear(n_hidden_fc1, n_classes, prm))

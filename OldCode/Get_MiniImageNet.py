...
# Note: For Mini-ImageNet:
#
# 1.  Download imagenet_fall11_urls.tgz from
# http://image-net.org/imagenet_data/urls/imagenet_fall11_urls.tgz
# and place tgz file in sub-dir named MiniImageNet in data dir
#
# 2. https://github.com/twitter/meta-learning-lstm/tree/master/data/miniImagenet
#  Download train, val, and test csv file and place in MiniImageNet dir
...
"""
The following is based on code from https://bitbucket.org/tsendeemts/metanet
...
def resize_save(data_path, out_file):
    ...
    for lbl in lbls:
        print(lbl)
        tar = tarfile.open(os.path.join(data_dir, 'fall11_urls.tar'))
...
# print("download image URLs for the relevant labels...")
# download_imgs()
print("train...")
